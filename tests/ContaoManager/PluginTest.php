...
namespace HeimrichHannot\LightboxGalleryBundle\ContaoManager {
    use HeimrichHannot\LightboxGalleryBundle\Test\ContaoManager\PluginTest;

    function class_exists($className) {
        return PluginTest::$encoreClassExist;
    }
}
...
namespace HeimrichHannot\LightboxGalleryBundle\Test\ContaoManager {
    ...
    class PluginTest extends ContaoTestCase
    {
         ...
         * @var bool
         */
        public static $encoreClassExist;
        ...
        public function testRegisterContainerConfiguration(): void
        {
            ...
            static::$encoreClassExist = true;
            $plugin->registerContainerConfiguration($loader, []);

            static::$encoreClassExist = false;
            $plugin->registerContainerConfiguration($loader, []);
        }
    }
}